...
RegisterNetEvent("rn-vehicleshop:setVehicleOwned",function(vehicleData)
    ...
    MySQL.Async.execute("INSERT INTO `player_vehicles` (`license`, `citizenid`, `vehicle`, `hash`, `mods`, `plate`, `state`) VALUES ('"..player.PlayerData.license.."', '"..player.PlayerData.citizenid.."', '"..vehicleData.displayName.."', '"..vehicleData.model.."', '".."{}".."', '"..vehicleData.plate.."', '"..stateVehicle.."')")
end)