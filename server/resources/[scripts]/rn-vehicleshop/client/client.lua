...
RegisterNUICallback("spawnVehicle", function(data,cb)
    ...
    if not spawnVehicle then
        ...
        loadVeh = true
        newVehicle = CreateVehicle(hash,-43.84, -1095.99, 26.42, 190.46, false, false)     
...
RegisterNUICallback("testDrive", function(data,cb)
    Core.Functions.TriggerCallback("vehicleshop:getMoney",function(bool)
        if bool then
            ...
            SetEntityCoords(PlayerPedId(), vector3(-57.3831, -1097.11, 26.422))
            DoScreenFadeIn(500)
        end
...
function changeCam()
    ...
    Wait(1000)
    inShop = true
    SetEntityCoords(PlayerPedId(), vector3(-46.14, -1103.07, 30.42))
    FreezeEntityPosition(PlayerPedId(), true)
    if not DoesCamExist(cam) then
        cam = CreateCam('DEFAULT_SCRIPTED_CAMERA', true)
    end
    SetCamActive(cam, true)
    SetCamRot(cam,vector3(-10.0,0.0, 337.53), true)
    SetCamFov(cam,50.0)
    SetCamCoord(cam, vector3(-46.14, -1103.07, 27.42))              
    PointCamAtCoord(cam,vector3(-46.14, -1103.07, 27.42))
